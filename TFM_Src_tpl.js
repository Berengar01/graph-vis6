var app = ( function() {
	...
	function initModels() {
        ...
        createModel("torus", fs, [1,-.3,-1], [0, 0, 0], [2, 2, 2]);
        createModel("plane", "wireframe",  [0, -1.6, 0], [0, 0, 0], 
            [1, 1, 1]);
	...
	function initEventHandler() {
		...
		window.onkeydown = function(evt) {
			...
			switch(c) {
				case('K'):
					interactiveModel.rotate[1]+=sign * deltaRotate*-1;
	...
	function updateTransformations(model) {
     ...
     // Rotate.
        ...
        mat4.rotate(mMatrix, mMatrix, -camera.zAngle, camera.center);
